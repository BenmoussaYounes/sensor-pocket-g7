...
Copiez `.env.example` vers `.env`, puis renseignez l'URL, le groupe et les
identifiants du broker. Au démarrage, le serveur écoute :
...
recevoir chaque mesure MQTT valide en temps réel. Les messages ont ce format :
